//課題１
//https://www.google.com/search?q=university&sca_esv=2a1890e936bb66bb&ei=yeoyZ4mjCbvj2roPodSGgQM&ved=0ahUKEwjJq6_4itaJAxW7sVYBHSGqITAQ4dUDCA8&oq=university&gs_lp=Egxnd3Mtd2l6LXNlcnAiCnVuaXZlcnNpdHlIAFAAWABwAHgBkAEAmAEAoAEAqgEAuAEMyAEAmAIAoAIAmAMAkgcAoAcA&sclient=gws-wiz-serp
// q=university
// https://www.google.com/search?q=university&kogakuin
...
document.addEventListener(
  ...
  function () {
    ...
    //https://www.kogakuin.ac.jp/important/efforts.htmlのurlのエラーが起こる
    //Javascriptはクロスオリジン通信ができないがゆえにこのエラーが起こる。
    ...
    document.getElementById("btn").addEventListener(
      ...
      function () {
        ...
        let url =
          "https://b.hatena.ne.jp/entry/jsonlite/?callback=showTags&url=" +
...
function countTags(data) {
  ...
  data.bookmarks.forEach((bookmark) => {
    if (bookmark.tag) {
      // 空のタグでないか確認
      tagCount.set(bookmark.tag, (tagCount.get(bookmark.tag) || 0) + 1);
    }
  });
  let sortedTags = Array.from(tagCount.entries()).sort((a, b) => b[1] - a[1]);
  result.innerHTML = "";
